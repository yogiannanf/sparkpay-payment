    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full py-16 bg-white">
        <div className="px-6 mx-auto text-center max-w-7xl">
          <h2 className="mb-4 text-3xl font-bold">SparkPay - Payment Gateway Indonesia</h2>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <Card className="transition-all duration-300 shadow-lg hover:shadow-xl">
              <CardContent className="flex flex-col items-center p-8">
                ...
                <h3 className="mb-3 text-xl font-semibold">Virtual Account Bank</h3>
            ...
            <Card className="transition-all duration-300 shadow-lg hover:shadow-xl">
              <CardContent className="flex flex-col items-center p-8">
                ...
                <h3 className="mb-3 text-xl font-semibold">Kartu Kredit/Debit</h3>
      ...
      <section className="w-full py-24 bg-slate-50">
        <div className="px-6 mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold md:text-4xl text-slate-800">Fitur Unggulan SparkPay</h2>
                ...
                <div className="h-full p-1">
                  <Card className="h-full transition-shadow duration-300 shadow-md hover:shadow-lg">
                    <CardContent className="flex flex-col items-start h-full gap-4 p-6">
                      ...
                      <p className="text-sm text-slate-600">Terima pembayaran dari Virtual Account bank, e-wallet, kartu kredit, QRIS, dan transfer bank dalam satu platform terintegrasi.</p>
                ...
                <div className="h-full p-1">
                  <Card className="h-full transition-shadow duration-300 shadow-md hover:shadow-lg">
                    <CardContent className="flex flex-col items-start h-full gap-4 p-6">
                      ...
                      <p className="text-sm text-slate-600">Monitor transaksi real-time, analisis performa bisnis, unduh laporan, dan kelola semua pembayaran dalam satu tempat yang mudah.</p>
                      <ul className="mt-auto space-y-2 text-sm">
                ...
                <div className="h-full p-1">
                  <Card className="h-full transition-shadow duration-300 shadow-md hover:shadow-lg">
                    <CardContent className="flex flex-col items-start h-full gap-4 p-6">
                      ...
                      <p className="text-sm text-slate-600">Dokumentasi lengkap, SDK multi-bahasa, plugin e-commerce, dan sample code yang memudahkan developer melakukan integrasi.</p>
                      <ul className="mt-auto space-y-2 text-sm">
                ...
                <div className="h-full p-1">
                  <Card className="h-full transition-shadow duration-300 shadow-md hover:shadow-lg">
                    <CardContent className="flex flex-col items-start h-full gap-4 p-6">
                      ...
                      <p className="text-sm text-slate-600">Terima notifikasi instan via webhook, email, dan SMS untuk setiap perubahan status transaksi secara real-time.</p>
                      <ul className="mt-auto space-y-2 text-sm">
                ...
                <div className="h-full p-1">
                  <Card className="h-full transition-shadow duration-300 shadow-md hover:shadow-lg">
                    <CardContent className="flex flex-col items-start h-full gap-4 p-6">
                      ...
                      <p className="text-sm text-slate-600">Sertifikasi PCI DSS Level 1, enkripsi SSL 256-bit, tokenisasi data, dan sistem anti-fraud untuk melindungi setiap transaksi.</p>
                      <ul className="mt-auto space-y-2 text-sm">
      ...
      <section className="w-full py-24 bg-[#F5FBF5]">
        <div className="px-6 mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            <h2 className="text-3xl font-bold md:text-4xl text-slate-800">Bagaimana SparkPay Bekerja?</h2>
            <p className="max-w-3xl mx-auto mt-4 text-lg text-slate-600">Proses pembayaran yang sederhana dan efisien untuk merchant dan customer.</p>
          </div>
              ...
              <div key={item.number} className="relative">
                <Card className="h-full bg-white border border-gray-200 shadow-sm rounded-xl">
                  <CardContent className="flex flex-col items-start h-full p-8 text-left">
                    ...
                    <p className="flex-grow mb-6 text-sm text-slate-600">{item.description}</p>
    ...
    <section className="relative w-full py-24 overflow-hidden bg-slate-50">
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-4xl px-6 mx-auto">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold md:text-4xl text-slate-800">Pertanyaan yang Sering Ditanyakan</h2>
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row">
              <div className="text-center md:w-2/3 md:text-left">
                ...
                <Button className="bg-[#3C8346] text-white hover:bg-green-700 font-semibold">
                  Hubungi Kami
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 ml-2" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" /></svg>
                </Button>
              </div>
